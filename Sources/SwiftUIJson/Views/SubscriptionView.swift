...
//extension SubscriptionView: IAnyView, DynaCodable where PublisherType : Combine.Publisher, Content : View, PublisherType.Failure == Never {
...
//        DynaType.register(SubscriptionView<AnyPublisherType, AnyView>.self)
//    }
//}
